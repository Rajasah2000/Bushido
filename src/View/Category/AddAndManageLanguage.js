...
const AddAndManageLanguage = () => {
  ...
  const AddLanguage = () => {
    ...
    if (name) {
      ...
      toast.error("Language Field Is Required");
    }
  };
  ...
  const UpdateLanguage = () => {
    ...
    if (name) {
      HomeService.UpdateLanguage(id, data)
        .then((res) => {
          if (res && res.status) {
...
export default AddAndManageLanguage;
